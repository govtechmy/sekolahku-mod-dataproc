...
@crons.cron("0 16 * * *") # Every day at 00:00 Malaysia Time
@crons.cron("*/30 * * * *") # Every 30 minutes - for testing purposes, can be removed in production
...
@crons.cron("0 16 * * 6") # Every Saturday at 00:00 Malaysia Time
